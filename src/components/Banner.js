...
export const Banner = () => {
  ...
  const toRotate = ['Front-End Developer', 'Logo Designer','Video Editor',]
  const period = 2000
            ...
            <TrackVisibility>
              {({ isVisible }) => (
                <div className={isVisible ? 'animate__animated animate__fadeIn' : ''}>
                  ...
                  <h1>
                    {`Hi! I'm AYESHA SADDIQA`}{' '}
                    <span className="txt-rotate" dataPeriod="1000" data-rotate='[  "Web Designer", "Logo Designer","Video Editor","SSM " ]'>
            ...
            <TrackVisibility>
              {({ isVisible }) => (
                <div className={isVisible ? 'animate__animated animate__zoomIn' : ''}>
                  <img src={headerImg} alt="Header Img" style={{position:'relative',top:'50px',borderRadius:'3%'}}/>
                </div>
              )}
            </TrackVisibility>
          </Col>
